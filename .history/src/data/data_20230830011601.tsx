...
export const credentials: TimelineItem[] = [
  {
    date: 'Year Obtained', // Replace with the actual year or date
    location: 'Professional Engineers Ontario (PEO)',
    title: 'Professional Engineer (P.Eng)',
    content: <p>Details or description about this credential, if any.</p>,
  },
  {
    date: 'Year Obtained', // Replace with the actual year or date
...
export const experience: TimelineItem[] = [
  {
    ...
    title: 'Senior Contract Management Buyer, Category Management',
    content: (
      <p>
