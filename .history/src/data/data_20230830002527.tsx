  ...
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        ...
        at <strong className="text-stone-100">Hydro One</strong> in construction and engineering procurement, supply chain management, project management, and category management.
      </p>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
