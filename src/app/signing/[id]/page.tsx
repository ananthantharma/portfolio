...
const BORDER_PALETTE = ['#6366f1', '#f43f5e', '#22c55e', '#fb923c', '#a855f7', '#06b6d4'];
        ...
        <div className="w-80 bg-white border-r border-gray-100 flex flex-col overflow-y-auto">
                ...
                return (
                  <div
                    ...
                    className={`flex items-center gap-2.5 p-2.5 rounded-xl cursor-pointer transition-all ${
                      activeRecipient === r.id ? 'bg-indigo-50 ring-1 ring-indigo-200' : 'hover:bg-gray-50'
                    }`}>
                    <div
          ...
          {isDraft && (
            <div className="p-4 border-b border-gray-50">
              ...
              <p className="text-[10px] text-gray-400 mb-3">Select a recipient above, then click to add fields</p>
                ...
                return (
                  <div
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-gray-400 truncate">{recipient?.name || 'Unknown'}</p>
                    </div>
                    {isDraft && (
                      <button
                    ...
                    <div
                      ...
                      {field.value ? (
                        ...
                        <div className="text-center pointer-events-none select-none px-2">
                          ...
                          <p className="text-[8px] text-gray-400 truncate">{recipient?.name}</p>
                        </div>
                      )}
