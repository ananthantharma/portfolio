...
export async function GET() {
    ...
    try {
        ...
        const defaultPrompt = "Analyze the text below and organize it into a structured format. Use headings, bullet points, and clear sections. If there are dates or tasks, highlight them.";
