...
export async function GET() {
    ...
    try {
        ...
        const defaultPrompt = "You are an expert editor. Rewrite the text to match the requested tone, style, and audience. Improve clarity, grammar, and flow while strictly adhering to the user's constraints.";
