                            ...
                            <Dialog.Panel className="w-full max-w-5xl transform overflow-hidden rounded-2xl bg-white p-6 shadow-xl transition-all">
                                ...
                                <div className="flex flex-col lg:flex-row gap-6 h-[600px]">
                                    ...
                                    <div className="w-full lg:w-1/4 space-y-6 overflow-y-auto pr-2">
                                        {/* Sliders */}
                                        {[
                                            { label: 'Professionalism', val: professionalism, set: setProfessionalism, min: 'Casual', max: 'Formal' },
                                    ...
                                    <div className="w-full lg:w-3/4 flex flex-col gap-4 h-full">
                                        ...
                                        <div className="flex-1 flex flex-col min-h-0">
                                            <label className="text-sm font-bold text-gray-700 mb-2 flex justify-between">
                                                ...
                                                <span className="text-gray-400 font-normal text-xs uppercase tracking-wide">Paste content here</span>
                                            </label>
                                            <textarea
                                        ...
                                        <div className="flex-1 flex flex-col min-h-0">
                                            <div className="flex justify-between items-center mb-2">
                                                ...
                                                {rewrittenText && (
                                                    <button className="text-xs flex items-center gap-1 text-purple-600 hover:text-purple-800 font-bold bg-purple-50 px-2 py-1 rounded-md" onClick={copyToClipboard}>
