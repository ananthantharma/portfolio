    ...
    return (
      <header className="fixed top-0 z-50 hidden w-full bg-neutral-900/50 p-4 backdrop-blur sm:block" id={headerID}>
        <nav className="flex justify-center gap-x-8">
          ...
          <Link className={inactiveClass} href="/smart-invoices">
            <span className="flex items-center gap-2">
              ...
              <div className="relative w-4/5 bg-stone-800">
                <nav className="mt-5 flex flex-col gap-y-2 px-2">
                  <div className="flex items-center justify-between px-2 mb-2">
                    <span className="text-gray-300 font-bold">Account</span>
                    <UserProfileMenu />
                  </div>
                  ...
                  <Link className={inactiveClass} href="/smart-invoices" onClick={toggleOpen}>
                    <span className="flex items-center gap-2">
                      <ReceiptPercentIcon className="h-5 w-5" /> Invoices
                    </span>
                  </Link>
