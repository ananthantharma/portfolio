...
const BudgetItemModal: React.FC<BudgetItemModalProps> = React.memo(({isOpen, onClose, onSave, initialData}) => {
  ...
  const availableSubcategories =
    type === 'Income' ? INCOME_CATEGORIES : BUDGET_CATEGORIES[category as keyof typeof BUDGET_CATEGORIES] || [];
