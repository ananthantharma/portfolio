            ...
            <div
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between mt-1">
                  <span className="text-[10px] font-medium text-slate-400">{formatCurrency(cat.spent)} spent</span>
                  <span className="text-[10px] font-medium text-slate-400">of {formatCurrency(cat.budgeted)}</span>
                </div>
              </div>
            </div>
          );
