...
export default function SourcingEventModal({
  ...
  const filteredPages =
    query === ''
      ? pages
      : pages.filter(page =>
          page.title.toLowerCase().replace(/\s+/g, '').includes(query.toLowerCase().replace(/\s+/g, '')),
        );
  ...
  }, [isOpen, initialData, defaultDescription, defaultEventName, sourcePageId]);
  ...
  const renderSelectWithAdd = (
    ...
    <div className={className}>
      <label className="block text-sm font-medium text-gray-700 mb-1 flex justify-between">
        ...
        <button
          type="button"
          onClick={() => handleAddFieldOption(configKey)}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                      ...
                      <div className="md:col-span-4">
                        <Combobox
                          ...
                          onChange={val => setFormData({...formData, sourcePageId: val})}>
                        ...
                        <p className="mt-1 text-xs text-gray-500">
                          Link this event to a specific notebook page for quick access.
                        </p>
                      </div>
                  ...
                  <div className="border border-gray-200 rounded-lg">
                    <CollapsibleSectionHeader
                      title="Ownership & Categorization"
                      section="ownership"
                        ...
                        <div className="md:col-span-4 flex gap-6">
                          <label className="inline-flex items-center">
                            <input
                              type="checkbox"
                              name="existingVendor"
                              checked={!!formData.existingVendor}
                              onChange={handleChange}
                          ...
                          <label className="inline-flex items-center">
                            <input
                              ...
                              checked={!!formData.diversityClassification}
                              onChange={handleChange}
                              className="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            />
                          ...
                          <label className="inline-flex items-center">
                            <input
                              type="checkbox"
                              name="indigenousOpportunity"
                              checked={!!formData.indigenousOpportunity}
                              onChange={handleChange}
                              className="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            />
                      ...
                      <div className="p-4 grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="col-span-1">
                          ...
                          <input
                            ...
                            name="effectiveDate"
                            value={
                              formData.effectiveDate ? new Date(formData.effectiveDate).toISOString().split('T')[0] : ''
                            }
                            onChange={handleChange}
                            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                          />
                  ...
                  <div className="border border-gray-200 rounded-lg">
                    <CollapsibleSectionHeader
                      title="Financials & Contracts"
                      section="financials"
                      isOpen={sectionsOpen.financials}
                    />
