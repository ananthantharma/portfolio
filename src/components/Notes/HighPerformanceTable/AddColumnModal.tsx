                                    ...
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                        ...
                                        <div className="mt-4">
                                            <form onSubmit={handleSubmit} className="space-y-4">
                                                <div>
                                                    <label htmlFor="col-name" className="block text-sm font-medium leading-6 text-gray-900">Name</label>
                                                    <div className="mt-1">
                                                        <input
                                                            type="text"
                                                            name="col-name"
                                            ...
                                            ${type === option.type ? 'border-indigo-600 ring-2 ring-indigo-600 bg-indigo-50' : 'border-gray-300 hover:bg-gray-50'}
                                        `}
