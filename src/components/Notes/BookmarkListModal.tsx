                  ...
                  {loading ? (
                    ...
                    <div className="grid gap-3 grid-cols-1">
                      {filteredBookmarks.map(bookmark => (
                        <div
                          key={bookmark._id}
                          className="group bg-white border border-gray-200 rounded-xl p-3 flex flex-col lg:flex-row gap-4 items-start lg:items-center hover:shadow-md hover:border-indigo-200 transition-all">
                          {/* Left: Link & Title */}
