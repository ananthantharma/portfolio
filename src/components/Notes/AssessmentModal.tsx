  ...
  const handleAnalyze = async () => {
    ...
    try {
      let payload: any = {
        ...
        model: useProModel ? 'gemini-pro-latest' : 'gemini-flash-latest',
      };
      ...
      // 2. DOCX -> Extract Text Client-Side
      ...
      // 3. Excel -> Extract Text Client-Side
            ...
            <Transition.Child
              ...
              <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                <div className="flex items-center justify-between border-b pb-4 mb-4">
                  <Dialog.Title
                    as="h3"
                    className="text-xl font-semibold leading-6 text-gray-900 flex items-center gap-2">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-6 hover:bg-gray-100 transition-colors">
                    <input
                      ...
                      type="file"
                    />
                    <label className="flex flex-col items-center cursor-pointer" htmlFor="file-upload">
                      <CloudArrowUpIcon className="h-12 w-12 text-gray-400 mb-2" />
                      <span className="text-sm font-medium text-gray-700">
                        {file ? file.name : 'Click to upload PDF, Word, or Excel'}
                      </span>
                      <span className="text-xs text-gray-500 mt-1">Supported formats: .pdf, .docx, .xlsx</span>
                    </label>
                  </div>
