...
import { Send, Bot, User, Loader2, Trash2, PlusCircle, FilePenLine } from 'lucide-react';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setMessages(prev => [...prev, {
                role: 'model',
                parts: `Error: ${error.message || 'Unknown error occurred'}. Please check your API key and try again.`
            }]);
        } finally {
            setIsLoading(false);
        }
