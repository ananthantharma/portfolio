    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-1 mb-8">
          {' '}
          {/* Full width for users table now */}
          {/* Users Section */}
                  ...
                  {groupedLogs.map(group => (
                    <React.Fragment key={group.ip}>
                      <tr
                          ...
                          <div className="flex items-center">
                            <span
                              className={`mr-2 transform transition-transform ${
                                expandedIps.has(group.ip) ? 'rotate-90' : ''
                              }`}>
                              ▶
                            </span>
                        ...
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{group.user}</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{group.totalVisits}</td>
                      </tr>
                              ...
                              <tbody className="divide-y divide-gray-200">
                                {group.logs.map((log: any) => (
                                  <tr key={log._id}>
                                    ...
                                    <td className="px-4 py-2 text-xs text-gray-900 font-mono">{log.path}</td>
                                    <td
                                      className="px-4 py-2 text-xs text-gray-500 truncate max-w-xs"
                                      title={log.userAgent}>
                                      {log.userAgent}
                                    </td>
                                  </tr>
